...
| [`bigboard/`](bigboard/) | Big Board (Digital Research Computers, Z80 CP/M; the Xerox 820's ancestor) | in mamedev (`bigboard`) |
...
| [`Xerox-820/`](Xerox-820/) | Xerox 820 / 820-II loose disk media (Z80 CP/M and application disks) | in mamedev (`x820`, `x820ii`, `x820ii5`, `x820iilp`, `x820iis`) |
...
| [`Siemens-PC-MX2/`](Siemens-PC-MX2/) | Siemens PC-MX2 (NS32016 Multibus SINIX multi-user system, 1985; boots SINIX V2.0) | in mamedev (`pcmx2`) + device work in progress |
